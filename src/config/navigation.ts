    ...
    children: [
      {
        ...
        icon: ClipboardList,
        permissions: ['purchase_requisition.view_all', 'purchase_requisition.view_own', 'purchase_requisition.create'],
      },
      {
        label: 'Purchase Orders',
        to: '/purchase-orders',
        icon: ClipboardCheck,
        permissions: ['purchase_order.view_all', 'purchase_order.view_own', 'purchase_order.create'],
      },
